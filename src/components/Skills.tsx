    ...
    <section id="skills" ref={sectionRef} className="py-12 sm:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4">
            ...
            >
              ...
              <div className="space-y-1.5">
                {cat.skills.map((skill, j) => (
                  // 原 GitHub 链接：href={`https://github.com/openclaw/skills/tree/main/skills`}
                  <a
                    key={j}
        ...
        <div className="reveal flex flex-col sm:flex-row items-center justify-center gap-4">
          {/* 隐藏 GitHub「浏览完整列表」按钮
          <a href="https://github.com/VoltAgent/awesome-openclaw-skills" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-2 px-6 py-3 bg-gray-900 hover:bg-gray-800 text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5">
