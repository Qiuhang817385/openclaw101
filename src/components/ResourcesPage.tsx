      ...
      <div ref={mainRef} className="max-w-5xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="reveal mt-12 relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="flex-1 relative">
            ...
            <p className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.6)' }}>{t.contributeDesc} <code className="px-1.5 py-0.5 rounded text-xs" style={{ background: 'rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.8)' }}>src/data/resources.ts</code>{t.contributeDesc2}</p>
          </div>
          <a href="https://github.com/mengjian-github/openclaw101" target="_blank" rel="noopener noreferrer" className="relative shrink-0 inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-900 font-semibold rounded-xl hover:shadow-lg transition-all hover:-translate-y-0.5">
