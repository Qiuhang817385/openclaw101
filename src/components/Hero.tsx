    ...
    <section className="relative min-h-[100svh] flex items-center justify-center hero-glow overflow-hidden pt-28 pb-10 sm:pt-0 sm:pb-0">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4">
          ...
          {/* 隐藏 GitHub 入口
          <a href="https://github.com/mengjian-github/openclaw101" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 sm:px-8 sm:py-4 border border-gray-300 hover:border-gray-400 font-semibold rounded-xl transition-all duration-300 hover:-translate-y-0.5 text-gray-800">
        ...
        <div className="hidden sm:mt-16 sm:flex items-center justify-center gap-8 md:gap-12">
          ...
          {/* 隐藏 GitHub Stars 统计
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-bold text-gray-900">145k+</div>
            <div className="text-xs text-gray-500">GitHub Stars</div>
          </div>
          <div className="w-px h-8 bg-gray-300" />
          */}
