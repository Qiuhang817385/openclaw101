...
const itemsZh = [
  ...
  /* 隐藏 GitHub：{ icon: '📦', title: 'OpenClaw GitHub', desc: '源代码 (145k+ ⭐) 和社区贡献', link: 'https://github.com/openclaw/openclaw', color: 'hover:border-gray-400 hover:bg-gray-50' },
  { icon: '⭐', title: 'MyClaw GitHub', desc: '本站源码，欢迎 Star 和 PR', link: 'https://github.com/mengjian-github/openclaw101', color: 'hover:border-yellow-300 hover:bg-yellow-50' }, */
  {
    icon: '📝',
    title: '飞书知识库',
    desc: '7 天入门指南 · 中文图文教程',
...
const itemsEn = [
  ...
  /* 隐藏 GitHub：{ icon: '📦', title: 'OpenClaw GitHub', desc: 'Source code (145k+ ⭐) and community contributions', link: 'https://github.com/openclaw/openclaw', color: 'hover:border-gray-400 hover:bg-gray-50' },
  { icon: '⭐', title: 'MyClaw GitHub', desc: "This site's source code. Star and PRs welcome!", link: 'https://github.com/mengjian-github/openclaw101', color: 'hover:border-yellow-300 hover:bg-yellow-50' }, */
  {
    icon: '📝',
    title: 'Feishu Wiki',
  ...
  return (
    <section id="community" ref={sectionRef} className="py-12 sm:py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* 隐藏 Contribute / Star & Fork on GitHub 横幅
        <div className="reveal bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 md:p-12 text-center">
          <h3 className="text-2xl font-bold mb-3" style={{ color: '#fff' }}>{isZh ? '🌟 一起让 MyClaw 变得更好' : '🌟 Help Make MyClaw Better'}</h3>
          <p className="mb-6 max-w-lg mx-auto" style={{ color: 'rgba(255,255,255,0.7)' }}>{isZh ? <>发现了好教程？写了使用心得？做了有趣的技能？<br />提一个 PR，你的贡献将帮助更多人。</> : <>Found a great tutorial? Wrote a guide? Built an interesting skill?<br />Submit a PR — your contribution will help others.</>}</p>
          <a href="https://github.com/mengjian-github/openclaw101" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-gray-900 font-semibold rounded-xl transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5">
