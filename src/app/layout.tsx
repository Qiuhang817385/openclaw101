...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://openclaw.meetai.fun/og-image.png',
        width: 1200,
        height: 630,
        alt: 'MyClaw - AI Assistant Tutorial',
      },
    ],
    locale: 'en_US',
    type: 'website',
...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'WebSite',
      '@id': 'https://openclaw.meetai.fun/#website',
      url: 'https://openclaw.meetai.fun',
      name: 'MyClaw',
    ...
    {
      '@type': 'FAQPage',
      '@id': 'https://openclaw.meetai.fun/#faq',
      mainEntity: [
        {
          '@type': 'Question',
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'You need a Linux server (Ubuntu 22.04+ recommended), Node.js 20+, and an API key for your chosen AI model. Clone the repository, run the setup wizard, configure your Telegram bot token, and start the gateway. The Day 2 tutorial at openclaw.meetai.fun/day/2 covers this step by step.',
          },
        },
        {
          '@type': 'Question',
    ...
    {
      '@type': 'ItemList',
      '@id': 'https://openclaw.meetai.fun/#tutorial-list',
